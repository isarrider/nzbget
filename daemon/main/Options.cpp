...
void Options::CheckDirs()
{
	...
	CheckDir(m_destDir, DESTDIR.data(), m_mainDir, false, false);
	CheckDir(m_interDir, INTERDIR.data(), m_mainDir, true, false);
	...
	CheckDir(m_scriptDir, SCRIPTDIR.data(), m_mainDir, true, false);
